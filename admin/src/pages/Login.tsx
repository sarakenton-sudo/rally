...
export function Login() {
  const { signIn, signInWithGoogle, admin } = useAdminAuth();
    ...
    <div className="flex min-h-screen items-center justify-center bg-bark">
      <div className="w-full max-w-sm rounded-xl bg-warm-white p-8 shadow-lg">
        ...
        <button
          ...
          className="mb-4 flex w-full items-center justify-center gap-2 rounded-md border border-frost bg-white px-4 py-2.5 text-sm font-medium text-bark shadow-sm hover:bg-cream transition-colors"
        >
        ...
        <div className="mb-4 flex items-center gap-3">
          <div className="h-px flex-1 bg-frost"></div>
