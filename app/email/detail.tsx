    ...
    try {
      ...
      if (existing) {
        ...
        const { error } = await insertHotelBooking({
          ...
          check_in: (cleanData.check_in as string) || null,
          check_out: (cleanData.check_out as string) || null,
          cancellation_deadline: (cleanData.cancellation_deadline as string) || null,
          cost: (cleanData.cost as number) ?? null,
          is_backup: false,
          status: 'confirmed',
