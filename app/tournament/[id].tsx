        ...
        <View className="px-4">
          ...
          <>
              ...
              <View className="flex-row items-center justify-between mt-6 mb-3">
                <View className="flex-row items-center">
                  <Ionicons name="bed" size={18} color={hotels.length > 0 ? '#7c3aed' : ic.muted} />
              ...
              <View className="flex-row items-center justify-between mt-6 mb-3">
                <View className="flex-row items-center">
                  <Ionicons name="airplane" size={18} color={flights.length > 0 ? '#3B82B0' : ic.muted} />
                  <Text className="text-sm font-semibold text-stone dark:text-parchment ml-2 uppercase tracking-wider">Flights</Text>
                </View>
                {flights.length > 0 && (
                  <View className="flex-row items-center gap-2">
                    <Pressable
                      className="flex-row items-center active:opacity-70 bg-rally-50 dark:bg-rally-900/20 px-2.5 py-1 rounded-full"
                      onPress={() => {
